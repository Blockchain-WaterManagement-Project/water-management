...
import {BarChart, GaugeChart, LineChart, NitrogenChart, PieChartConcentration, PieChartLoad, ScatterChart} from '../structure/graphs';
import { nitrogen_data, phosphorus_data, ammonium_data } from '../../data/sample.data';
                    ...
                    <div className="row">
                        <div className='col-sm-12 d-flex justify-content-center items-center gap-3 p-2 mb-3'>
                            <div className='card' style={{ width: '20rem'}}>
                                ...
                                <h5 className='text-center text-uppercase mb-3' style={{ fontSize: '1rem'}}>Total Nitrogen</h5>
                            </div>
                            <div className='card border-0' style={{ width: '20rem'}}>
                                <GaugeChart data={phosphorus_data} type={'Phosphorus'}/>
                                <h5 className='text-center text-uppercase mb-3' style={{ fontSize: '1rem'}}>Total Phosphorus</h5>
                            </div>
                            <div className='card' style={{ width: '20rem'}}>
                                <GaugeChart data={ammonium_data} type={'Ammonium Nitrogen'}/>
                                <h5 className='text-center text-uppercase mb-3' style={{ fontSize: '1rem'}}>Total Ammonium Nitrogen</h5>
                            </div>                
                        </div>
                        ...
                        <div className='col-sm-6 card p-2 mb-3'>
                            <PieChartLoad nitrogen={nitrogen_data} phosphorus={phosphorus_data} ammonium={ammonium_data}/>
                        </div>
                        <div className='col-sm-6 card p-2 mb-3'>
                            <PieChartConcentration nitrogen={nitrogen_data} phosphorus={phosphorus_data} ammonium={ammonium_data}/>
                        </div>
                    </div>
                </div>
            </div>
