...
// Generate a re-encryption key (for demonstration, this is a simple proxy step)
...
// Endpoint to generate re-encryption key
app.post("/reencryption-key", (req, res) => {
...
// Endpoint to re-encrypt ciphertext
...
const PORT = 3000;
app.listen(PORT, () => {
    console.log(`Proxy Re-encryption API is running on http://localhost:${PORT}`);
});